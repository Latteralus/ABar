...
export const STARTER_PROPERTY: Property = {
  ...
  description: "A small, worn dive bar on a quiet commercial strip. Low rent, loyal walk-in traffic, and just enough room to get started.",
  ...
  existingEquipment: [
    {
      id: "equip-bar-station-1",
      name: "Basic Bar Station",
